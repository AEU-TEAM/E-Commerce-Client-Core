  ...
  <v-container class="mt-10">
    <v-row justify="center" align="center">
      ...
      <v-col cols="12" md="6" lg="6">
        <v-card>
          <v-icon @click="goHome" class="mb-4" left>mdi-arrow-left</v-icon>
...
import { useRouter } from "vue-router"; // ✅ required for router.push
...
const submitForm = () => {
  if (validateForm()) {
    ...
    console.log({ ...form }); // ✅ Spread to avoid reactive object serialization issues
    ...
    formRef.value?.resetValidation?.(); // Optional chaining in case method doesn't exist
  }
};
</script>
